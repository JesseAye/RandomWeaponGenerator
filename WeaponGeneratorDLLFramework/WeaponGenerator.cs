...
namespace WeaponGenerator
{
	...
	public class WeaponGenerator
	{
		...
		{
			List<WeaponType> weaponChances = new List<WeaponType>();
		...
		{
			_chance[WeaponType.AssaultRifle] = value;
			_chance[WeaponType.BoltActionRifle] = value;
			_chance[WeaponType.BreakActionShotgun] = value;
			_chance[WeaponType.Handgun] = value;
			_chance[WeaponType.HeavyMachineGun] = value;
			_chance[WeaponType.LightMachineGun] = value;
			_chance[WeaponType.PumpActionShotgun] = value;
			_chance[WeaponType.Revolver] = value;
			_chance[WeaponType.SemiautomaticRifle] = value;
			_chance[WeaponType.SemiautomaticShotgun] = value;
			_chance[WeaponType.SubmachineGun] = value;
		}
		...
		{
			Weapon[] weapons = new Weapon[Amount];
			Random rand_Weapon = new Random();
			int rand;
			...
			for (int i = 0; i < Amount; i++)
			{
				...
				weapons[i] = GetWeapon(ChancePool[rand]);
			}
